...
public class StringMethod {
	...
	public static void main(String[] args) {
		  ...
		  String str = "hashim"; String str1 = "hashim";
		  
		  String s = new String("hashim"); String s1 = new String("hashim");
		  ...
		  System.out.println("14--> "+s1.trim());
		  System.out.println("16--> "+str.substring(1,3));
		  System.out.println("17--> "+str.replace("h", "G"));
		 
		  byte[] b= {72,97,115,104,105,109};
			
			  String s2=new String(b);
			   System.out.println("18--> "+s2);
